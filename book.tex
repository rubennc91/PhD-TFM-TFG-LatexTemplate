...
\input{Book/cover/cover.tex}                       % DO NOT TOUCH THIS
...
\input{Book/dedication/dedicatoria.tex}            % EDIT this file or
                                              % comment it out
\input{Book/acknowledgements/agradecimientos.tex}  % EDIT this file or
                                              % comment it out

% If this is the case, include definitions of acronyms (it's 
% included before resumen.tex and abstract.tex in case you want
% to use them here 
\input{Book/acronyms/defacronymsgl.tex}            % EDIT this file or
...
% included before resumen.tex and abstract.tex in case you want
% to use them there 
\input{Book/symbols/defsymbolsgl.tex}              % EDIT this file or
                                              % comment it out if you do 
                                              % not use acronyms

% Now include resumen and abstract
\input{Book/abstract/resumen.tex}                  % EDIT this file
\input{Book/abstract/abstract.tex}                 % EDIT this file
...
\input{Book/cover/toc+lof+lot.tex}                 % DO NOT TOUCH THIS LINE!
...
% appendix/manual.tex) 
\input{Book/cover/extralistings.tex}               % Edit this file or
                                              % comment it out

% Now include list of acronyms and options (if this is the case)
\input{Book/acronyms/acronymsgl.tex}               % EDIT this file or
                                              % comment it out if you do 
                                              % not use acronyms

% Now include symbols of symbols and options (if this is the case)
\input{Book/symbols/symbolsgl.tex}                 % EDIT this file or
                                              % comment it out if you do 
                                              % not use acronyms
...
\input{Book/chapters/introduccion.tex}

\input{Book/chapters/estudioTeorico.tex}

\input{Book/chapters/desarrollo.tex}

\input{Book/chapters/resultados.tex}

\input{Book/chapters/conclusiones.tex}

% Optional in PFCs
%\input{pliego/pliego.tex}

% Optional in PFCs, compulsory in TFGs
\input{Book/presupuesto/presupuesto.tex}
...
\begin{appendices}
  ...
  \input{Book/appendix/herramientas.tex}
  \input{Book/appendix/versiones.tex}
\end{appendices}
%
...
% to use it
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{Book/cover/backpage.tex}                    % EDIT this file if

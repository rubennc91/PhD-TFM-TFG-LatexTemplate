...
\lstinputlisting[style=Cbluebox]{Book/appendix/function.c}
\inputencoding{utf8}
...
\begin{codefloat}
\lstinputlisting[style=Cnice]{Book/appendix/hello.c}
...
\begin{codefloat}
\lstinputlisting[style=Cnice,numbers=none]{Book/appendix/hello.c}
...
\begin{codefloat}
\lstinputlisting[style=Ccolor]{Book/appendix/hello.c}

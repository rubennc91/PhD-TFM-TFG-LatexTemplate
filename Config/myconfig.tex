...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Advisor data
\newcommand{\myAcademicTutorFullName}{NOMBRE TUTOR} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CoAdvisor data
\newcommand{\myCoTutorFullName}{NOMBRE TUTORA} 
\newcommand{\myCoTutorGender}{female}
\newcommand{\myCoTutorDNI}{22222222-B}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Affiliation
\newcommand{\mySchool}{Escuela Superior de Ciencias Experimentales y Tecnología}
\newcommand{\myUniversity}{Universidad Rey Juan Carlos}
\newcommand{\myUniversityAcronym}{URJC}

\newcommand{\myDepartment}{Departamento de Matemática Aplicada, Ciencia e Ingeniería de los Materiales y Tecnología Electrónica}
\newcommand{\myDepartmentEnglish}{Departament of Applied Mathematics, Materials Science and Engineering and Electronics Technology}
...
\newcommand{\myDepartmentSecretary}{Name of the secretary Department} % Por TFGs & TFMs & MUSEA-TFMs paperwork
\newcommand{\myDepartmentSecretaryGender}{female}                 % Por TFGs & TFMs & MUSEA-TFMs paperwork
\newcommand{\myTFMComisionPresident}{Name of the Commision President}      % Por MUIE TFMs, no need to define gender... presidentE always
...
\newcommand{\myThesisDefenseYear}{2021/22}
...
\newcommand{\myResearchVicerrector}{Excmo. Sr. VICERRECTOR/A}
